// Instructions
// In this exercise, the logic for a sequence of numbers will be tested. You will have to create a function which will return true if the number is the sum of its own digits, where each digit is first raised to the power of the number of digits.
